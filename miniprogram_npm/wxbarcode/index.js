...
__DEFINE__(1599018547537, function(require, module, exports) {
module.exports = require('./demo/utils')
}, function(modId) {var map = {"./demo/utils":1599018547538}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1599018547538, function(require, module, exports) {
...
}, function(modId) { var map = {"./barcode":1599018547539,"./qrcode":1599018547540}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1599018547539, function(require, module, exports) {
const PATTERNS = [
    [2, 1, 2, 2, 2, 2, 0, 0],  // 0
    [2, 2, 2, 1, 2, 2, 0, 0],  // 1
    [2, 2, 2, 2, 2, 1, 0, 0],  // 2
...
function charCompatible(chr, codeset) {
    ...
    return csa === CODESET.B && codeset === CODESET.B;
}
...
__DEFINE__(1599018547540, function(require, module, exports) {
    const QR = (function () {
...
return __REQUIRE__(1599018547537);
})()
